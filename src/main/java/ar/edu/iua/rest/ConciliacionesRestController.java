...
public class ConciliacionesRestController extends BaseRestController {
    ...
    public ResponseEntity<Conciliacion> getConciliacionByCodigoExterno(@RequestParam("codigo_externo") String codigoExterno) {
        try {
            return new ResponseEntity<Conciliacion>(conciliacionBusiness.getConciliacionByCodigoExterno(codigoExterno), HttpStatus.OK);
        } catch (BusinessException e) {
            log.error(e.getMessage(), e);
            return new ResponseEntity<Conciliacion>(HttpStatus.INTERNAL_SERVER_ERROR);
        } catch (NotFoundException e) {
